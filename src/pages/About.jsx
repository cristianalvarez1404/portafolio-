...
const About = () => {
  return (
    <div className="mb-10 lg:mb-20" id="about">
      <h1 className="text-4xl w-1/2 m-auto border-t-2 border-gray-200 p-4 text-center mb-5 lg:text-6xl">
        Acerca de mí
      </h1>
      <div className="w-[80%] lg:w-[90%] m-auto flex flex-col lg:flex-row lg:items-center">
        ...
        <div className="flex-1 p-2 ">
          <div className="flex items-center gap-4 bg-green-200 p-5 rounded-2xl mb-3 cursor-pointer hover:bg-green-300">
            <TbBracketsAngle className="hidden lg:block text-3xl" />
            <div className="">
          ...
          <div className="flex items-center gap-4 bg-purple-200 p-5 rounded-2xl mb-3 cursor-pointer hover:bg-green-300">
            <FaUser className="hidden lg:block text-2xl" />
            <div className="">
          ...
          <div className="flex items-center gap-4 bg-green-200 p-5 rounded-2xl mb-3 cursor-pointer hover:">
            <FaBagShopping className="hidden lg:block text-2xl" />
            <div className="">
          ...
          <div className="flex items-center gap-4 bg-purple-200 p-5 rounded-2xl mb-3 cursor-pointer hover:bg-green-300">
            <FaFileCode className="hidden lg:block text-2xl" />
            <div className="">
